...
const ERROR_MESSAGE_KEYS = {
  ...
  invalidOutputSuffix: "errors.invalidOutputSuffix",
  sourceOverwriteConfirmationRequired: "errors.sourceOverwriteConfirmationRequired",
...
const REQUIRED_MESSAGE_PARAMS: Partial<Record<CommandErrorCode, readonly string[]>> = {
  ...
  outputExists: ["path"],
  sourceOverwriteConfirmationRequired: ["path"],
