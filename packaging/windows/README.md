...
- The NSIS configuration includes a bounded post-uninstall retry for only `ImgConvert.exe`, covering a short-lived Windows file handle without broad or recursive deletion.
